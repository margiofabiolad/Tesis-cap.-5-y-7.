...
\subsection{Edad del Universo}
  ...
  \end{equation}
   ...
   \begin{empheq}[box=\fbox]{align}
        \ddot{a} & = - \frac{\pi G \Omega_0 H_0^2 }{ a^2}, \\
        \notag \\
        \dot{a}^2 & = \frac{\pi G \Omega_0 H_0^2  }{a} - \frac{c^2}{R'^2}.
    \end{empheq}
   ...
   \begin{wrapfigure}{r}{0.5\linewidth}                  \includegraphics[width=0.65\textwidth]{milne_model.png}
